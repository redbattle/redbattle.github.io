<template>
  <el-container class="app-container">
    <el-aside class="relative" width="auto">
      <div class="text-gray-780 font-medium text-xl text-center app-container-logo">管理平台</div>
      <el-menu
        ...
        :collapse="isCollapse"
      >
        <el-menu-item-group v-if="menuCode.includes($route.meta.menuCode)" @click.native="clickMenu('user.list')">
          <el-menu-item index="user">用户权限</el-menu-item>
        </el-menu-item-group>
        <el-menu-item-group v-if="menuCode.includes($route.meta.menuCode)" @click.native="clickMenu('home.index')">
    ...
    <div class="relative flex-1">
      <el-header class="flex items-center app-container-header">
        ...
        ></i>
        <i v-show="!isCollapse" class="el-icon-s-fold text-2xl mr-4 cursor-pointen" @click="handlerCollapse(true)"></i>
        ...
        <div>
          <el-dropdown trigger="hover" :hide-on-click="false" @command="handleuser">
      ...
      <el-main class="bg-gray-50 app-container-main" :class="{ 'app-container-main-collapse': isCollapse }">
